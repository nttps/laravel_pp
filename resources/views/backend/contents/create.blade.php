...
@section('breadcrumb')
    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__item">
            <a href="{{ route('admin.contents.promotion.index') }}" class="m-nav__link">
                <span class="m-nav__link-text">Promotion  </span>
            </a>
        </li>
        <li class="m-nav__separator">-</li>
        <li class="m-nav__item">
            <span class="m-nav__link-text">{{ isset($data) ? 'Edit' : 'Create' }} Promotion</span>
        </li>
    </ul>
@stop
...
<form class="m-form m-form m-form--state m-form--label-align-right" action="@if(isset($data)){{ route('admin.contents.update' , $data->id) }}@else{{ route('admin.contents.promotion.post') }} @endif" method="POST" enctype="multipart/form-data" id="productFrom">
    @csrf()
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                {{ isset($data) ? 'Edit' : 'Create' }} A Promotion
                            </h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group m-form__group row {{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <input type="text" name="name" class="form-control m-input" id="name" aria-describedby="" placeholder="Enter product name" value="{{ isset($data->title) ? $data->title : old('name') }}" required>
                                    @if ($errors->has('name'))
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group m-form__group row {{ $errors->has('slug') ? 'has-danger' : '' }}">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <input type="text" id="slug" name="slug" class="form-control m-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter product slug" value="{{ isset($data->slug) ? $data->slug : old('slug') }}" required>
                                    @if ($errors->has('slug'))
                                        <div class="form-control-feedback">
                                            {{ $errors->first('slug') }}
                                        </div>
                ...
                <div class="m-portlet__body">
                   <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a href="/admin/promotion/" class="btn btn-secondary">
                                Cancel
                            </a>
                        </div>
                    </div>
