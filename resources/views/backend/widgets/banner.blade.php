    ...
    init: function () {
        ...
        t = $(".m_datatable").mDatatable({
            data: {
                ...
                source: {
                    read: {
                        url: "{{ route('admin.widgets.banner.index') }}",
                        method: 'get'
                    }
                },
                pageSize: 10,
            ...
            columns: [{
                ...
                template: function (t, e, a) {
                    return '\t\t\t\t\t\t<a href="/admin/widgets/banner/'+t.id+'/edit" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">\t\t\t\t\t\t\t<i class="la la-edit"></i>\t\t\t\t\t\t</a>\t\t\t\t\t\t'
                }
            }]
        })
    }
