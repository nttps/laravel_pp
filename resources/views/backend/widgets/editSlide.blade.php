...
@section('breadcrumb')
    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__separator">-</li>
        <li class="m-nav__item">
            <a href="{{ route('admin.widgets.slide.index')}}" class="m-nav__link">
                <span class="m-nav__link-text">Slide</span>
            </a>
        </li>
        <li class="m-nav__separator">-</li>
        <li class="m-nav__item">
            <span class="m-nav__link-text">Edit Slide</span>
        </li>
    </ul>
@stop
        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                <h3 class="m-portlet__head-text">
                    {{ isset($data) ? 'Edit' : 'Create' }} A Slide
                </h3>
            </div>
        </div>
    </div>
    <!--begin::Form-->
    <form class="m-form m-form m-form--state m-form--label-align-right" action="@if(isset($data)) {{ route('admin.widgets.slide.update' , $data->id)}} @else {{ route('admin.product.datas.store') }} @endif" method="POST" enctype="multipart/form-data">
    @csrf()
