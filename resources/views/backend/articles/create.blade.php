...
@section('breadcrumb')
    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
        ...
        <li class="m-nav__separator">-</li>
        <li class="m-nav__item">
            <span class="m-nav__link-text">{{ isset($data) ? 'Edit' : 'Create' }} Article</span>
        </li>
    </ul>
@stop
...
<form class="m-form m-form m-form--state m-form--label-align-right" action="@if(isset($data)){{ route('admin.article.update' , $data->id) }}@else{{ route('admin.article.store') }} @endif" method="POST" enctype="multipart/form-data" id="productFrom">
    @csrf()
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                {{ isset($data) ? 'Edit' : 'Create' }} A Article
                            </h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6 col-sm-12">
                            <div class="form-group m-form__group row {{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    <input type="text" name="name" class="form-control m-input" id="name" aria-describedby="" placeholder="Enter product name" value="{{ isset($data->name) ? $data->name : old('name') }}" required>
                                    @if ($errors->has('name'))
