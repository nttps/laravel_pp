...
<body>
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <iframe src="/files" style="width: 100%; height: 500px; overflow: hidden; border: none;"></iframe>
      </div>
    </div>
  </div>
  ...
  <script>
    $('#lfm').filemanager('images', {prefix: route_prefix});
      ...
      var LFMButton = function(context) {
          ...
          var button = ui.button({
              ...
              click: function() {
                  ...
                  lfm({type: 'image', prefix: '/files'}, function(url, path) {
      ...
      $('#summernote-editor').summernote({
          toolbar: [
            ...
            //    ['para', ['justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull']],
              ['height', ['height']],
              ['insert', ['lfm' , 'table' , 'video' , 'hr' ,'link']],
