...
@section('custom-css')
    ...
    <meta property="og:description" content="{{ 'เกร็ดความรู้ '.getSetting('site_description')}}">
...
@section('content')
    <div class="container mt-5 mb-5">
        <div class="row">
        <h2 class="col-12"> KNOWLEDGE TAG: {{ $tagName }}<hr class="border-warning border-bottom my-0"> </h2>
        </div>
        <div class="row">
